...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m2(className) => "${Intl.select(className, {'Organization': 'Organização', 'OrganizationConfiguration': 'Configuração da Organização', 'OrganizationDirectoryService': 'Serviço de Diretório', 'User': 'Usuário', 'UserProfile': 'Perfil do Usuário', 'UserAccess': 'Acesso do Usuário', 'UserIdentity': 'Identidade do Usuário', 'Group': 'Grupo', 'Objective': 'Objetivo', 'Measure': 'Medida', 'MeasureProgress': 'Progresso da Medida', 'UnitOfMeasurement': 'Unidade de Medida', 'Work': 'Trabalho', 'WorkStage': 'Estágio', 'WorkItem': 'Item de Trabalho', 'WorkItemValue': 'Valor do Item de Trabalho', 'other': 'Não Definido', })}";
  ...
  static m10(fieldName) => "${Intl.select(fieldName, {'nameField': 'Nome', 'inactiveField': 'Inativo', 'leaderField': 'Líder', 'groupTypeIndexField': 'Tipo do Grupo', 'superGroupField': 'Super Grupo', 'membersField': 'Membros', 'other': 'Não Definido', })}";

  static m11(label) => "${Intl.select(label, {'company': 'Organização', 'businessUnit': 'Unidade de Negócio', 'department': 'Departamento', 'team': 'Time', 'other': 'Não Definido', })}";
  ...
  static m13(label) => "${Intl.select(label, {'insightsLabel': 'Insights', 'groupLabel': 'Grupo', 'leaderLabel': 'Lider', 'objectivesOverallLabel': 'Visão Geral dos Objetivos', 'objectivesLabel': 'Objetivos', 'objectivesDescriptionLabel': 'Número total de objetivos', 'objectivesAchievedLabel': 'Objetivos Alcançados', 'objectivesAchievedDescriptionLabel': 'Objetivos com média das medidas acima de 70%', 'objectivesRequiringAttentionDescriptionLabel': 'Objetivos com média das medidas abaixo de 30%', 'objectivesRequiringAttentionLabel': 'Objetivos Requerendo Atenção', 'worksLabel': 'Trabalhos', 'worksDescriptionLabel': 'Número total de trabalhos', 'worksCompletedLabel': 'Trabalhos Concluídos', 'worksCompletedDescriptionLabel': 'Trabalhos com 100% dos itens de trabalho concluídos', 'worksRequiringAttentionLabel': 'Trabalhos Requerendo Atenção', 'worksRequiringAttentionDescriptionLabel': 'Trabalhos com itens de trabalho atrasados', 'workItemsLabel': 'Itens de Trabalho', 'workItemsDescriptionLabel': 'Número total de items de trabalho', 'workItemsNotStartedLabel': 'Itens de Trabalho Não Iniciados', 'workItemsNotStartedDescriptionLabel': 'Itens de Trabalho no estado de não iniciado', 'workItemsInProgressLabel': 'Itens de Trabalho em Progresso', 'workItemsInProgressDescriptionLabel': 'Itens de trabalho no estado em progresso', 'workItemsCompletedLabel': 'Items de Trabalho Concluídos', 'workItemsCompletedDescriptionLabel': 'Itens de Trabalho com 100% de progresso', 'workItemsRequiringAttentionLabel': 'Itens de Trabalho Requerendo Atenção', 'workItemsRequiringAttentionDescriptionLabel': 'Itens de trabalho atrasados', 'worksMyWorkItemsLabel': 'Meus Itens de Trabalho', 'other': 'Não Definido', })}";

  static m14(label) => "${Intl.select(label, {'notificationLabel': 'Notificação', 'ofTheLabel': 'do(a)', 'thisLabel': 'deste(a)', 'other': 'Not Defined', })}";
  ...
  static m31(moduleName) => "${Intl.select(moduleName, {'groups': 'Grupos', 'users': 'Usuários', 'objectives': 'Objetivos', 'organization': 'Organização', 'works': 'Trabalhos', 'other': 'Não Definido', })}";
  ...
  static m34(label) => "${Intl.select(label, {'percentLabel': 'Percentual', 'moneyLabel': 'Monetário', 'indexLabel': 'Índice', 'unitaryLabel': 'Unitário', 'monthLabel': 'Mês', 'dayLabel': 'Dia', 'hourLabel': 'Hora', 'other': 'Não Definido', })}";
  ...
  static m38(fieldName) => "${Intl.select(fieldName, {'identificationField': 'Identificação', 'passwordField': 'Senha', 'passwordHashField': 'Senha Hash', 'passwordSaltField': 'Senha Salt', 'providerField': 'Provedor', 'providerObjectIdField': 'Id do Objeto Provedor', 'other': 'Não Definido', })}";
  ...
  static m44(fieldName) => "${Intl.select(fieldName, {'nameField': 'Nome', 'finishedField': 'Finalizado', 'other': 'Não Definido', })}";

  static m45(fieldName) => "${Intl.select(fieldName, {'nameField': 'Nome', 'descriptionField': 'Descrição', 'dueDateField': 'Data Limite', 'plannedValueField': 'Planejado', 'actualValueField': 'Real', 'unitOfMeasurementField': 'Unidade de Medida', 'workStageField': 'Estágio', 'assignedToField': 'Atribuído para', 'attachmentsField': 'Anexos', 'checkItemsField': 'Itens de Checagem', 'archivedField': 'Archived', 'workField': 'Trabalho', 'other': 'Não Definido', })}";

  static m46(label) => "${Intl.select(label, {'workKanbanLabel': 'Trabalho Kanban', 'workItemsLabel': 'Itens de Trabalho', 'workItemsGanttLabel': 'Gantt de Itens de Trabalho', 'workItemsFilterLabel': 'Filtro de Items de Trabalho', 'orderedByLabel': 'Ordenado Por', 'editWorkItemLabel': 'Editar Itens de Trabalho', 'addWorkItemLabel': 'Adicionar Item de Trabalho', 'selectAValueLabel': 'Selecionar um Valor', 'workItemsOverDueLabel': 'Itens de Trabalho Atrasados', 'checkItemLabel': 'Item de Checagem', 'dropFileHereLabel': 'Soltar Arquivo Aqui', 'checkItemNameLabel': 'Nome do Item de Checagem', 'plannedActualLabel': 'Planejado e Real', 'remainingValueLabel': 'Valor Restante', 'dateAndActualValueLabel': 'Data e Valor Real', 'other': 'Não Definido', })}";
