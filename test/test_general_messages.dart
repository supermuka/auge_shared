...
void main() {
  ...
  group('Test Class and Fields name equivalence.', () {
    ...
    test('Objective.', () async {
      checkEquivalence(objective_m.Objective, objective_measure_pb.Objective);
    });
    test('Measure.', () async {
      checkEquivalence(measure_m.Measure , objective_measure_pb.Measure);
    });
    test('Measure Progress.', () async {
      checkEquivalence(measure_m.MeasureProgress , objective_measure_pb.MeasureProgress);
    });
    test('Work.', () async {
      checkEquivalence(work_m.Work , work_work_item_pb.Work);
    });
    test('Work Stage.', () async {
      checkEquivalence(work_stage_m.WorkStage, work_work_item_pb.WorkStage);
    });
    test('Work Item.', () async {
      checkEquivalence(work_item_m.WorkItem, work_work_item_pb.WorkItem);
    });
    test('Work Item Value.', () async {
      checkEquivalence(work_item_m.WorkItemValue, work_work_item_pb.WorkItemValue);
    });
    test('Work Item Check Item.', () async {
      checkEquivalence(work_item_m.WorkItemCheckItem, work_work_item_pb.WorkItemCheckItem);
    });
    test('Work Item Attachment.', () async {
      checkEquivalence(work_item_m.WorkItemAttachment, work_work_item_pb.WorkItemAttachment);
    });
  });
